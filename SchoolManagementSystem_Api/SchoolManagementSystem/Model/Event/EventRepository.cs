...
namespace SchoolManagementSystem
{
    public class EventRepository : IEventRepository
    {
        ...
        //Rokeya
        public IEnumerable<Event> GetBranchWiseAllEvent(int BranchId, int year)
        {
        ...
        public IEnumerable<Event> GetBranchWiseAllEvent1(int BranchId, int year, int month)
        {
        ...
        public IEnumerable<Event> GetBranchWiseAllEvent2(int BranchId, int year, int month, int date)
        {
