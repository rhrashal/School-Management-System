        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClassRoom_BranchClass_BranchClassId",
                        column: x => x.BranchClassId,
                        principalTable: "BranchClass",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Student_BranchClass_BranchClassId",
                        column: x => x.BranchClassId,
                        principalTable: "BranchClass",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ResultPublishDate = table.Column<DateTime>(nullable: false),
                    TotalMark = table.Column<int>(nullable: false),
                    TotalObtainMark = table.Column<int>(nullable: false),
                    ResultStatus = table.Column<bool>(nullable: false),
                    GradePoint = table.Column<double>(nullable: false),
                    HighestMark = table.Column<float>(nullable: true),
                    Position = table.Column<int>(nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassRoom_BranchClassId",
                table: "ClassRoom",
                column: "BranchClassId");
